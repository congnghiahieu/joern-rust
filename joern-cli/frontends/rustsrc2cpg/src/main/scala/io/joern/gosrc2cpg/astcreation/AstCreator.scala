...
class AstCreator(
  ...
  protected override def code(node: io.joern.rustsrc2cpg.ast.nodes.Node): String = "Ignore"

  protected def column(node: io.joern.rustsrc2cpg.ast.nodes.Node): Option[Integer] = Option(0)

  protected def columnEnd(node: Node): Option[Integer] = Option(0)

  protected def line(node: io.joern.rustsrc2cpg.ast.nodes.Node): Option[Integer] = Option(0)

  protected def lineEnd(node: io.joern.rustsrc2cpg.ast.nodes.Node): Option[Integer] = Option(0)
